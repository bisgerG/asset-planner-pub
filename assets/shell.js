...
{key:'backwardation',term:'逆價差',short:'未來月份的期貨比現在便宜，長期持有的人反而佔便宜。',long:'台股的 2 倍 ETF 用期貨來放大部位，而期貨有到期日，每個月得換到下一個月的合約。當下個月的報價比較便宜（這就叫逆價差），換約等於打折續約，過去把台股正二的持有成本壓到接近零（本站用的 00685L 掛牌至今 9.3 年,扣完所有費用的實際落後只有 0.15%/年）。但 2022 年之後這個折扣反轉成溢價，等於變成倒收你錢。「① 配資金」把它固定抓 3%/年，旁邊會顯示最近實測到多少給你對照。⚠ 它真的會變：2015–2021 是順風（等於免費槓桿），2022 之後反轉成逆風。'},
